...
int main(int argc, char *argv[]) {
    ...
    if (size < 1) {
        ...
        a = (float *)clSVMAlloc(context, CL_MEM_READ_WRITE | CL_MEM_SVM_FINE_GRAIN_BUFFER, size * size * sizeof(float), 0);
/*malloc(size * size * sizeof(float));*/
        InitMat(fp, size, a, size, size);

        b = (float *)clSVMAlloc(context, CL_MEM_READ_WRITE | CL_MEM_SVM_FINE_GRAIN_BUFFER, size * sizeof(float), 0);
...
/*malloc(size * sizeof(float));*/
    ...
    m = (float *)clSVMAlloc(context, CL_MEM_READ_WRITE | CL_MEM_SVM_FINE_GRAIN_BUFFER, size * size * sizeof(float), 0);
/*malloc(size * size * sizeof(float));*/
